        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(
                        authorize -> authorize
                                ...
                                .requestMatchers("/auth/register", "/auth/login", "auth/forgot/**","auth/reset/**").permitAll()
                                ...
                                .requestMatchers(HttpMethod.POST,"/restaurant/file/").hasRole("RESTAURANT")
                                .requestMatchers(HttpMethod.GET,"/restaurant/file/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT,"/restaurant/authorize/**").hasRole("ADMIN")
                                ...
                                .requestMatchers("/order/prepare/{orderId}").hasRole("RESTAURANT")
                                .requestMatchers(HttpMethod.GET,"/order/restaurant/**").hasRole("RESTAURANT")
                                .requestMatchers("/order/take/**","/order/deliver/**","/order/courier/**").hasRole("COURIER")
                                ...
                                .requestMatchers(HttpMethod.GET,"/menu-item/{id}").permitAll()
                                .requestMatchers("/menu-item/**").permitAll()
                                .requestMatchers("/auth/send","/auth/activation/**").authenticated()
                                .requestMatchers(HttpMethod.GET,"card/user").hasRole("CUSTOMER")
